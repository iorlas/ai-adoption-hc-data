...
## Dropped: the notation

July wrote the four parts inside angle-bracket tags. Sarah stopped the session
over it, and the group never adopted it. **It was never required** — it was one
person's habit.

Everything in these two sessions is written in plain sentences. The four parts
still matter; they are just sentences now.
